...
proc create_root_design { parentCell } {
  ...
  set LEDS_GPIO [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LEDS_GPIO ]
  ...
  set_property CONFIG.channels {1} $lowlevel_dac_intfc_0
...
\
  ...
  set DIPS_AND_LEDS [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 DIPS_AND_LEDS ]
  set_property -dict [list \
